...
const URGENCY_CHIPS: {
  ...
  { id: "emergency", label: PLUMBER_FINAL_COPY.emergency, fee: "1.25x · base + call-out" },
  { id: "remote", label: PLUMBER_FINAL_COPY.remote, fee: "1.35x · base + call-out" },
  { id: "night", label: PLUMBER_FINAL_COPY.night, fee: "1.5x · base + call-out" },
];
