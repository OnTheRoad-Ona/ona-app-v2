...
export const PRO_TRADE_OPTIONS: {
...
}[] = [
  {
    ...
    label: "Mechanic",
    homeLabel: "Mechanic",
    hint: "Engine, brakes, general repairs",
    icon: Wrench,
  ...
  },
  {
    ...
    label: "Battery",
    homeLabel: "Battery",
    hint: "Jump start, replace, charge",
    icon: Battery,
  ...
  },
  {
    ...
    label: "Electrical",
    homeLabel: "Electric",
    hint: "Wiring, alternator, sensors",
    icon: Plug,
