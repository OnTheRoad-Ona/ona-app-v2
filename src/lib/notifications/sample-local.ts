...
export function localSampleNotifications(
  ...
  if (role === "professional") {
    return [
      ...
      },
      {
        ...
        priority: "critical",
        title: "Safety alert",
        body: "Motorist shared an SOS pin. Call support if needed.",
        href: "/jobs",
        actionType: "open_job",
        createdAt: ago(5),
      },
  ...
  return [
    ...
    },
    {
      ...
      // Finished job — no deep link / action (navigation gated)
      href: null,
      actionType: "none",
      jobId: "demo-job-m2",
      jobStatus: "completed",
    ...
    },
    {
      ...
      priority: "critical",
      title: "Safety / SOS",
      body: "If you feel unsafe, call emergency services. OgaMecho Care is notified.",
      actionType: "none",
      createdAt: ago(1),
    },
    {
