...
const URGENCY_CHIPS: {
  ...
  { id: "normal", label: PLUMBER_FINAL_COPY.normal, fee: "1x · base + call-out" },
  { id: "emergency", label: PLUMBER_FINAL_COPY.emergency, fee: "1.25x" },
  { id: "remote", label: PLUMBER_FINAL_COPY.remote, fee: "1.35x" },
  { id: "night", label: PLUMBER_FINAL_COPY.night, fee: "1.5x" },
];
              ...
              <div className={cn("rounded-[4px] px-3 py-2.5", rowCard)}>
                ...
                {finalStep === "photos" ? (
                  <div>
                    ...
                    >
                      {photos.length}/{PLUMBER_MIN_PHOTOS} photos added — 2 are
                      required
                    </p>
                    <input
                      ref={photoRef}
