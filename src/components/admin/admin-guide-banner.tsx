  ...
  return (
    ...
    >
      ...
      {open && (
        ...
        >
          <Section title="What is this page?">{guide.what}</Section>
          <Section title="How does it work?">{guide.how}</Section>
          <Section title="How do I use it?">{guide.use}</Section>
        </div>
      )}
    </div>
  );
    ...
    <div style={{ marginTop: 10 }}>
      <p
        style={{
          ...
          fontWeight: 700,
          fontSize: 12,
          color: "var(--om-text-muted, #6b7280)",
        }}
      >
        {title}
      </p>
