...
export const SHOP_TRADE_TAXONOMY: TradeSeed[] = [
  {
    ...
    name: "Mechanic",
    vehicleBased: true,
    // Full Nigerian Mechanic Shop taxonomy lives in mechanic-taxonomy.ts
    // (30 branches + subcategories). Roots listed here for UI fallbacks.
    roots: [
      { slug: "engine-engine-parts", name: "Engine & Engine Parts" },
      { slug: "transmission-gearbox", name: "Transmission & Gearbox" },
      { slug: "clutch", name: "Clutch" },
      { slug: "brake-system", name: "Brake System" },
      ...
      { slug: "air-intake", name: "Air Intake" },
      { slug: "exhaust-emissions", name: "Exhaust & Emissions" },
      { slug: "filters", name: "Filters" },
      { slug: "ignition", name: "Ignition" },
      { slug: "belts-pulleys-tensioners", name: "Belts, Pulleys & Tensioners" },
      { slug: "bearings-seals", name: "Bearings & Seals" },
      { slug: "lubricants-fluids", name: "Lubricants & Fluids" },
      { slug: "electrical-starting-charging", name: "Electrical & Starting/Charging" },
      { slug: "sensors-electronics", name: "Sensors & Electronic Components" },
      { slug: "engine-control-ecu", name: "Engine Control / ECU" },
      { slug: "body-interior", name: "Body & Interior (Mechanic)" },
      { slug: "hvac-ac", name: "HVAC / A/C" },
      { slug: "lighting", name: "Lighting" },
      { slug: "wheels-related", name: "Wheels Related (Mechanic)" },
      { slug: "tools-hand", name: "Hand Tools" },
      { slug: "tools-power", name: "Power Tools" },
      { slug: "diagnostic-tools", name: "Diagnostic Tools" },
      { slug: "garage-equipment", name: "Garage Equipment" },
      { slug: "consumables-chemicals", name: "Consumables & Chemicals" },
      { slug: "safety-ppe", name: "Safety & PPE" },
      { slug: "fasteners-hardware", name: "Fasteners & General Hardware" },
      { slug: "maintenance-service", name: "Maintenance & Service" },
    ],
  },
  {
    key: "vulcanizer",
