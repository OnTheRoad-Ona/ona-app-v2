...
const URGENCY_CHIPS: {
  ...
  { id: "emergency", label: CARPENTER_FINAL_COPY.emergency, fee: "1.25x" },
  { id: "remote", label: CARPENTER_FINAL_COPY.remote, fee: "1.35x" },
  { id: "night", label: CARPENTER_FINAL_COPY.night, fee: "1.5x" },
];
              ...
              <div className={cn("rounded-[4px] px-3 py-2.5", rowCard)}>
                ...
                {finalStep === "photos" ? (
                  <div>
                    ...
                    >
                      {photos.length}/{CARPENTER_MIN_PHOTOS} photos added — 2 are
                      required
                    </p>
                    <input
                      ref={photoRef}
