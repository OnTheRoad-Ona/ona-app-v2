...
function CheckoutInner() {
  ...
  const chargeBreakdown = useMemo(() => {
    ...
    return buildCustomerChargeMajor(job.agreedMajor);
  }, [job?.agreedMajor]);
  ...
  return (
    <div className={cn("relative flex h-full flex-col", sheet)}>
      ...
      {phase === "expired" ? (
        ...
        <div className="flex min-h-0 flex-1 flex-col overflow-y-auto px-4 pb-6 scrollbar-hide">
          ...
          <button
            ...
            className="mt-4 inline-flex h-12 w-full items-center justify-center rounded-2xl border-0 bg-[#FF6B35] text-[14px] font-black text-white"
          >
            I paid
          </button>
          <button
            ...
            className={cn("mt-2 text-center text-[13px] font-semibold", muted)}
          >
            Cancel
          </button>
        </div>
        ...
        <div className="flex-1 overflow-y-auto px-4 pb-6 scrollbar-hide">
            ...
            {chargeBreakdown ? (
              <div className={cn("mt-3 space-y-1 text-[11px] font-semibold", muted)}>
                ...
                <p className="pt-1 text-[10px] font-medium leading-snug">
                  ...
                  fee — do not change the transfer amount. After the job, Ona
                  splits escrow (pro 87.5% · Ona 5% · VAT 7.5% on Flutterwave).
                </p>
              </div>
            ) : null}
          </div>
          ...
          <button
            ...
            className="mt-5 inline-flex h-14 w-full items-center justify-center gap-2 rounded-2xl border-0 bg-[#FF6B35] text-[15px] font-black text-white disabled:opacity-45"
          >
