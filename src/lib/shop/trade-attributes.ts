...
export const TRADE_ATTRIBUTE_SCHEMAS: TradeAttributeSchema[] = [
  {
    ...
    attributes: [
      ...VEHICLE_FITMENT,
      {
        ...
        type: "enum",
        filterable: true,
        options: ["0W-20", "5W-30", "5W-40", "10W-30", "10W-40", "15W-40"],
      },
      {
        key: "capacity",
        label: "Capacity",
  ...
  },
  {
    ...
    attributes: [
      ...
      },
      {
        ...
        type: "enum",
        filterable: true,
        options: ["Tubeless", "Tube", "Run-flat"],
      },
  ...
  },
  {
    ...
    attributes: [
      ...
      },
      {
        ...
        type: "enum",
        filterable: true,
        options: ["Electric", "Hydraulic", "Manual"],
      },
  ...
  },
  {
    ...
    attributes: [
      ...VEHICLE_FITMENT,
      {
        ...
        type: "enum",
        filterable: true,
        options: ["R-134a", "R-410A", "R-32", "R-22", "R-404A", "R-600a"],
      },
      {
        key: "btuCapacity",
        label: "Capacity",
      ...
      },
      {
        ...
        type: "enum",
        filterable: true,
        options: ["Rotary", "Scroll", "Reciprocating", "Screw"],
      },
      {
        key: "application",
        label: "Application",
  ...
  },
  {
    ...
    attributes: [
      ...
      },
      {
        ...
        type: "enum",
        filterable: true,
        options: ["Lead-acid", "AGM", "Gel", "Lithium-ion", "LiFePO4"],
      },
      {
        key: "terminalType",
        label: "Terminal",
        type: "enum",
        filterable: true,
        options: ["Top post", "Side post", "L-terminal"],
      },
      {
        key: "crankingAmps",
        label: "CCA",
  ...
  },
  {
    ...
    attributes: [
      ...VEHICLE_FITMENT,
      {
        ...
        type: "enum",
        filterable: true,
        options: ["OBD-II", "CAN", "J1850", "ISO 9141", "KWP2000"],
      },
      {
        key: "connectivity",
        label: "Connectivity",
        type: "enum",
        filterable: true,
        options: ["Bluetooth", "Wi-Fi", "USB", "Wired"],
      },
      {
        key: "updateable",
        label: "Updateable",
      ...
      },
      {
        ...
        type: "enum",
        filterable: true,
        options: ["Color", "Monochrome", "None (mobile app)"],
      },
    ],
  },
  {
    ...
    attributes: [
      ...
      },
      {
        ...
        type: "enum",
        filterable: true,
        options: ["Black", "White", "Red", "Blue", "Green", "Gold", "Multi"],
      },
      {
        key: "machineType",
        label: "Machine type",
  ...
  },
  {
    ...
    attributes: [
      ...
      },
      {
        ...
        type: "enum",
        filterable: true,
        options: ["Potable water", "Drainage", "Gas", "Heating"],
      },
      ...HARDWARE,
    ],
  },
  {
    ...
    attributes: [
      ...
      },
      {
        ...
        type: "enum",
        filterable: true,
        options: ["Furniture", "Structural", "Doors", "Cabinetry", "Roofing"],
      },
      {
        key: "toolPower",
        label: "Power",
  ...
  },
  {
    ...
    attributes: [
      ...
      },
      {
        ...
        type: "enum",
        filterable: true,
        options: ["Hybrid", "Off-grid", "On-grid", "String", "Micro"],
      },
      {
        key: "capacity",
        label: "Capacity",
  ...
  },
  {
    ...
    attributes: [
      ...
      },
      {
        ...
        type: "enum",
        filterable: true,
        options: ["Petrol", "Diesel", "Gas", "Solar hybrid"],
      },
      {
        key: "phase",
        label: "Phase",
      ...
      },
      {
        ...
        type: "enum",
        filterable: true,
        options: ["Recoil", "Electric", "Remote", "Auto"],
      },
    ],
  },
];
...
export function getTradeAttributeSchema(
  tradeKey: string,
): TradeAttributeSchema | null {
...
export function tradeAttributeKeys(tradeKey: string): Set<string> {
  return new Set(
    (getTradeAttributeSchema(tradeKey)?.attributes ?? []).map((a) => a.key),
  );
}
...
export function validateTradeAttributes(
  ...
  for (const def of schema.attributes) {
    ...
    if (v === undefined || v === null || v === "") {
      errors.push(
        `Attribute "${def.key}" (${def.label}) is required for trade "${tradeKey}"`,
      );
    }
  }
